...
export function AppProvider({ children }: { children: ReactNode }) {
  ...
  useEffect(() => {
    ...
    return () => { window.clearTimeout(timeout); if (fallbackTimer) window.clearInterval(fallbackTimer); socket?.close(); };
