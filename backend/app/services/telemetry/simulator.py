...
class Simulator:
    def __init__(self) -> None:
        ...
        self.state: dict[str, Any] = {
            ...
            'heading': 0.0, 'flight_mode': 'GUIDED',
            'battery_percentage': 100.0, 'battery_voltage': 12.6,
            'estimated_remaining_flight_time': 20, 'signal_strength': 100.0,
            'gps_fix': True, 'gps_satellites': 10, 'vibration': 0.0,
            'temperature': 35.0, 'motor_outputs': [0, 0, 0, 0],
        ...
        try:
            self.master = mavutil.mavlink_connection(mav_url)
        ...
        if self.master:
            while True:
                ...
                if msg_type == 'GLOBAL_POSITION_INT':
                    ...
                    s['battery_percentage'] = float(msg.battery_remaining) if msg.battery_remaining >= 0 else 0.0
