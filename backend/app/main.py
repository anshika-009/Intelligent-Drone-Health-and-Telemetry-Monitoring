...
from app.schemas.telemetry import Credentials, ScenarioRequest, LocationUpdate
...
tokens: dict[str, str] = {}
location_logs: list[LocationUpdate] = []
...
def drone_history() -> list[LocationUpdate]:
...
async def location_socket(websocket: WebSocket):
    ...
    try:
        while True:
            ...
            location_logs.append(loc)
            await websocket.send_json(loc.dict())
