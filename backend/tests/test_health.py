...
def test_low_battery_rule():
    telemetry = {'battery_percentage': 22, 'signal_strength': 90, 'vibration': .2, 'gps_fix': True, 'temperature': 38}
...
def test_gps_loss_rule():
    telemetry = {'battery_percentage': 90, 'signal_strength': 90, 'vibration': .2, 'gps_fix': False, 'temperature': 38}
